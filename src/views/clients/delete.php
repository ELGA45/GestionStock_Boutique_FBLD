  ...
  <div class="container-fluid">
    <div class="container mt-5">
        <div class="card p-4 shadow" style="max-width: 500px; margin: auto;">
            <h4 class="text-center mb-4">Voulez-vous supprimer ce client ?</h4>
            <p class="text-center"><strong><?= htmlspecialchars($infoClient['nom']) ?></strong></p>

            <form action="/GestionStock_Boutique_FBLD/public/routeurs/client.php?action=delete" method="POST">
