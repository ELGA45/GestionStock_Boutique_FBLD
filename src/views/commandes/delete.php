  ...
  <div class="container-fluid">
    <div class="container mt-5">
        <div class="card p-4 shadow" style="max-width: 500px; margin: auto;">
            ...
            <p class="text-center"><strong><?= htmlspecialchars($infoCmd['client']) ?></strong></p>

            <form action="/GestionStock_Boutique_FBLD/public/routeurs/commande.php?action=delete" method="POST">
